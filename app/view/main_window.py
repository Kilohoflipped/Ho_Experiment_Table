...
from .mcu_manage_interface import MCUManageInterface
...
class MainWindow(FramelessWindow):
    ...
    def __init__(self):
        ...
        self.mcuManageInterface = MCUManageInterface(self)
        ...
        self.stackWidget.addWidget(self.mcuManageInterface)
    ...
    def initNavigation(self):
        ...
        self.mcuManageInterface.setObjectName('mcuManageInterface')
        ...
        self.navigationInterface.addItem(
            routeKey=self.mcuManageInterface.objectName(),
            icon=Icon.ALBUM,
            text=self.tr('MCU Manage'),
            onClick=lambda t: self.switchTo(self.mcuManageInterface, t),
            position=NavigationItemPostion.SCROLL
        )
